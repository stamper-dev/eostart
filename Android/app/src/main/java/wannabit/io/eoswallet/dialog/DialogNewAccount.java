...
public class DialogNewAccount extends DialogFragment {
    ...
    public static DialogNewAccount newInstance(Bundle bundle) {
        DialogNewAccount frag = new DialogNewAccount();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View contentView    = View.inflate(getContext(), R.layout.dialog_newaccount, null);
        ...
        singleOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((WellcomeActivity)getActivity()).onStartWebPage();
                getDialog().dismiss();
